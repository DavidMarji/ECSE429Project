Feature: Assign Todo to a Project with Tasksof
  ...
  # Normal Flow
  Scenario: Successfully adding an existing todo to a project
  ...
  # Alternate Flow
  Scenario: Successfully adding an existing todo already assigned to a project to a different project
  ...
  # Error Flow
  Scenario: Error when adding the todo to a non-existent project with String id
    Given a todo exists
  ...
  # Error Flow
  Scenario: Error when adding the todo to a non-existent project with int id
    Given a todo exists
