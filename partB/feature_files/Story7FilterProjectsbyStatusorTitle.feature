Feature: Filter Projects by Status or Title
  ...
  # Normal Flow
  Scenario: Successfully filtering projects by active status
  ...
  Scenario: Successfully filtering projects by title substring
  ...
  Scenario: Successfully filtering projects by completed status
  ...
  # Error Flow
  Scenario: No matching projects found for filter criteria
